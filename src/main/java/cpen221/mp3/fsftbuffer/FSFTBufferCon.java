 ...
 */
public class FSFTBufferCon<T extends Bufferable> {
     ...
     */
    public FSFTBufferCon(int capacity, int timeout) {
        buffer = new HashMap<>();
     ...
     */
    synchronized private void updateBuffer(int currentTime) {
